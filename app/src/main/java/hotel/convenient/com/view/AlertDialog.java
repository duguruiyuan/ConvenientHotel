...
public class AlertDialog {
	...
	private boolean showEtPsw = false;
	...
	public AlertDialog setEdVisiable(){
		showEtPsw=true;
		return this;
	}
	...
	public AlertDialog setPositiveButton(String text,
		...
		setPositiveButton(text,listener,true);
		return this;
	}
	public AlertDialog setPositiveButton(String text,
										 final OnClickListener listener, final boolean isAutoShow) {
		showPosBtn = true;
		if ("".equals(text)) {
			btn_pos.setText("确定");
		} else {
